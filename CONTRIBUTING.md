...
# Contributing to next-route-visualizer
...
> [Documentation](https://github.com/DiiiaZoTe/next-route-visualizer).

Before you ask a question, it is best to search for existing [Issues](https://github.com/DiiiaZoTe/next-route-visualizer/issues)
that might help you. In case you have found a suitable issue and still need clarification, you can write your question
in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/DiiiaZoTe/next-route-visualizer/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](https://github.com/DiiiaZoTe/next-route-visualizer). If you are
  looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  is not already a bug report existing for your bug or error in the the issues list.
...
- Open an [Issue](https://github.com/DiiiaZoTe/next-route-visualizer/issues/new). (Since we can't be sure at this point whether
...
- If the team is able to reproduce the issue, it will be worked on as soon as possible.

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for next-route-visualizer, **including completely new
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/DiiiaZoTe/next-route-visualizer) carefully and find out if the functionality is already
  covered, maybe by an individual configuration.
- Perform a [search](https://github.com/DiiiaZoTe/next-route-visualizer/issues) to see if the enhancement has already been
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/DiiiaZoTe/next-route-visualizer/issues).
...
- **Explain why this enhancement would be useful** to most next-route-visualizer users. You may also want to point out the other
