...
export const FilesPageIcon = ({ color }: { color?: string }) => {
  return (
    <svg width="24" height="24" fill={color ?? '#000'} viewBox="0 0 16 16">
...
export const FilesErrorIcon = ({ color }: { color?: string }) => {
  return (
    <svg width="24" height="24" fill={color ?? '#000'} viewBox="0 0 16 16">
...
export const FilesLayoutIcon = ({ color }: { color?: string }) => {
  return (
    <svg width="24" height="24" fill={color ?? '#000'} viewBox="0 0 16 16">
...
export const FilesRouteIcon = ({ color }: { color?: string }) => {
  return (
    <svg width="24" height="24" fill={color ?? '#000'} viewBox="0 0 16 16">
...
export const FilesLoadingIcon = ({ color }: { color?: string }) => {
  return (
    <svg width="24" height="24" fill={color ?? '#000'} viewBox="0 0 16 16">
